...
if "target_profit_usd" not in st.session_state:
    st.session_state.target_profit_usd = 0.0
...
# --- 🤖 MAIN OPERATIONAL TRADING DASHBOARD ---
    ...
    if app_mode == "🤖 Trading Core Suite":
        ...
        if launch_action:
            ...
            val_profit_usd = float(profit_usd_val) if profit_usd_val else 5.0
        ...
        if st.session_state.show_success:
            ...
            with box_col1:
                ...
                st.success(f"🎯 **User Target Profit Set:** {round(st.session_state.target_profit_usd, 2)} USDT")
            ...
            with box_col2:
                ...
                viral_text = (
                    ...
                    f"💰 *Today's Desired Profit Target:* {round(st.session_state.target_profit_usd, 2)} USDT\n"
